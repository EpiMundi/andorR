...
[![CRAN status](https://www.r-pkg.org/badges/version/andorR)](https://CRAN.R-project.org/package=andorR)
<!-- badges: end -->

`andorR` (pronounced ‘Andorra’) is an R package for the analysis and optimisation of expert system AND-OR decision trees. It helps manage the process of gathering evidence and reaching conclusions under uncertainty, aiming to minimize resource use and maximise confidence.
