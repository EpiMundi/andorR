...
#' @format A data frame with 5 variables and 50 rows, in relational format, in
...
#' @format A data frame with 5 variables and 34 rows, in relational format, in
#'   which hierarchical relationships are indicated by a value indicating
#'   the parent of each node.
#' \describe{
#'    Each rows represents a node or leaf in the tree and the columns represent
...
#' Ethical investment decision tree for a fictional company - hierarchical format
...
#'   a path down the tree to each leaf. This is the format generated by reading
#'   data from a YAML file in hierarchical format.
#' \describe{
